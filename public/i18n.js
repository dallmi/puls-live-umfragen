...
const DICT = {
  ...
  'presenter.error.generic': { de: 'Aktion fehlgeschlagen — bitte erneut versuchen.', en: 'Action failed — please try again.' },
  'presenter.rotate.menu': { de: 'Moderationslink neu erzeugen', en: 'Regenerate presenter link' },
  'presenter.rotate.title': { de: 'Neuen Moderationslink erzeugen?', en: 'Regenerate presenter link?' },
  'presenter.rotate.body': { de: 'Der bisherige Link wird sofort ungültig. Nutze danach nur noch den neuen Link — er wird automatisch unter „Meine Präsentationen" aktualisiert.', en: 'The current link becomes invalid immediately. Use only the new link afterwards — it is updated automatically under "My presentations".' },
  'presenter.rotate.confirm': { de: 'Neu erzeugen', en: 'Regenerate' },
  'presenter.save.conflict': { de: 'Konflikt', en: 'Conflict' },
  'presenter.conflict.title': { de: 'In anderem Tab geändert', en: 'Changed in another tab' },
  'presenter.conflict.body': { de: 'Diese Präsentation wurde in einem anderen Tab oder Fenster gespeichert. Um Datenverlust zu vermeiden, lade die aktuelle Version neu.', en: 'This presentation was saved in another tab or window. To avoid data loss, reload the current version.' },
  'presenter.conflict.reload': { de: 'Neu laden', en: 'Reload' },
  'presenter.error.saveBeforePresent': { de: 'Die Folien konnten nicht gespeichert werden. Bitte Verbindung prüfen und erneut „Präsentieren" klicken.', en: 'Could not save your slides. Please check your connection and click "Present" again.' },
  'presenter.quiz.deleteCorrectTitle': { de: 'Richtige Antwort löschen?', en: 'Delete correct answer?' },
  'presenter.quiz.deleteCorrectWarn': { de: 'Diese Option ist als richtige Antwort markiert. Nach dem Löschen musst du eine neue richtige Antwort wählen.', en: 'This option is marked as the correct answer. After deleting you must choose a new correct answer.' },
  'presenter.quiz.deleteCorrectConfirm': { de: 'Trotzdem löschen', en: 'Delete anyway' },
  ...
  'vote.error.generic': { de: 'Senden fehlgeschlagen — bitte erneut versuchen.', en: 'Submit failed — please try again.' },
  'vote.error.busy': { de: 'Zu viele Anfragen oder Folie voll — kurz warten.', en: 'Too many requests or slide full — please wait.' },
  'vote.error.already': { de: 'Du hast bereits abgestimmt.', en: 'You have already voted.' },
  'vote.gone.title': { de: 'Sitzung beendet', en: 'Session ended' },
  'vote.gone.desc': { de: 'Diese Umfrage ist nicht mehr verfügbar — der Moderator hat sie beendet oder sie ist abgelaufen.', en: 'This poll is no longer available — the host ended it or it expired.' },
  'presenter.gone.title': { de: 'Präsentation nicht mehr verfügbar', en: 'Presentation no longer available' },
  'presenter.gone.desc': { de: 'Diese Präsentation wurde gelöscht oder ist abgelaufen.', en: 'This presentation was deleted or has expired.' },
